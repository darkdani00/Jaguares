                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="row  mb-2">
                            ...
                            <div class="col-9">
                                <div>Grado de cinta: <span class="text-dark"><?=$profe->grado_cinta_maestro?></span>
                                </div>
                            </div>
                        </div>
                        <div class="row  mb-2">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-danger" data-key="<?=$profe->id_maestro;?>" id="delete-profe"><i
                                class="fas fa-trash"></i></button>

                        <button class="btn btn-success" data-key="<?=$profe->id_maestro ;?>" id="edit-profe"
